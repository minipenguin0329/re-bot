...
const styles = StyleSheet.create({ body: { flex: 1, paddingHorizontal: 24, paddingTop: 28, paddingBottom: 16 }, title: { fontSize: 21, fontWeight: '800' }, copy: { fontSize: 14, color: colors.muted, marginTop: 10 }, cards: { flex: 1, justifyContent: 'space-evenly', marginTop: 16, gap: 12 }, buttons: { flexShrink: 0, marginTop: 16, flexDirection: 'row', gap: 14 }, flex: { flex: 1 } });
