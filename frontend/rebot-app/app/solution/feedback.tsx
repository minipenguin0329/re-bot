...
const styles = StyleSheet.create({ body: { flex: 1, alignItems: 'center', paddingHorizontal: 24, paddingVertical: 24, justifyContent: 'space-evenly' }, title: { fontSize: 20, fontWeight: '800' }, reactions: { flexDirection: 'row', gap: 90 }, copy: { textAlign: 'center', color: '#888', fontSize: 15, lineHeight: 22, fontWeight: '600' }, notice: { fontSize: 10, lineHeight: 16, textAlign: 'center', color: colors.muted } });
