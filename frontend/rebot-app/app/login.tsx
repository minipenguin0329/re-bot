...
export default function LoginScreen() {
  ...
  return <Screen contentStyle={styles.screen}>
    ...
    <View style={styles.form}>
      ...
      <View style={styles.options}><Text style={styles.option}>로그인 상태는 안전하게 유지돼요</Text></View>
    </View>
