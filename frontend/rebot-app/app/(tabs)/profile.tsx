...
const menus = [{ label: '회원정보 수정', icon: 'person-outline', route: '/profile/edit' }, { label: '대화 내역', icon: 'time-outline', route: '/history' }, { label: '알림 설정', icon: 'notifications-outline', route: '/profile/notifications' }, { label: '고객센터', icon: 'help-circle-outline', route: '/profile/support' }] as const;
...
export default function ProfileScreen() {
  ...
  return <Screen bottomSafe={false}><AppHeader title="마이페이지" /><ScrollView
    style={styles.scroll}
