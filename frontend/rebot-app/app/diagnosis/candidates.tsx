...
const styles = StyleSheet.create({ flex: { flex: 1 }, scrollContent: { flexGrow: 1 }, body: { flex: 1, paddingHorizontal: 24, paddingTop: 4 }, title: { fontSize: 20, fontWeight: '800', marginTop: 4 }, copy: { fontSize: 14, color: colors.muted, marginTop: 8 }, cards: { marginTop: 32, gap: 24 }, customCard: { minHeight: 190, borderRadius: 20, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, padding: 20 }, customNumber: { fontSize: 13, fontWeight: '800', color: colors.muted }, customTitle: { marginTop: 8, fontSize: 17, fontWeight: '700', color: colors.text }, customDescription: { marginTop: 8, fontSize: 13, lineHeight: 20, color: colors.muted }, customInput: { marginTop: 16, minHeight: 64, borderRadius: 14, backgroundColor: colors.background, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, lineHeight: 20, color: colors.text, textAlignVertical: 'top' }, footer: { marginTop: 'auto', alignItems: 'center', gap: 4 }, nav: { flexDirection: 'row', justifyContent: 'space-between', width: '100%' }, navEnd: { justifyContent: 'flex-end' }, navButton: { flexDirection: 'row', alignItems: 'center', gap: 2 }, navText: { fontSize: 16, fontWeight: '700', color: colors.text }, page: { fontSize: 13, color: colors.muted }, disabled: { opacity: 0.5 }, missing: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 20, paddingHorizontal: 24 } });
