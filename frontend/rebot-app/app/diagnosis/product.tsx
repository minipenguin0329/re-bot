...
const styles = StyleSheet.create({ screen: { paddingHorizontal: 24, paddingVertical: 16, alignItems: 'center' }, title: { marginTop: 'auto', fontSize: 25, lineHeight: 32, fontWeight: '800', textAlign: 'center' }, product: { width: 208, height: 225, maxHeight: '32%', backgroundColor: colors.surfaceStrong, marginTop: 32, alignItems: 'center', justifyContent: 'center' }, buttons: { marginTop: 'auto', width: '100%', gap: 16 } });
