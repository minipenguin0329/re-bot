-- Recovery migration for environments where the original analysis-chat
-- migration was skipped. The previous migration shared its version prefix
-- with another file, so this unique version makes deployment deterministic.
